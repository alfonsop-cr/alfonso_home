...
**☆** (icono, sin texto «Estudiar») vive a la derecha de `.hecho-titulo`: `[visto ○] [h3 flex:1] [☆]`. `.hora-agregado` solo muestra la hora (`padding-left: 36px`). Idle muted · press / `.is-ok` usa `--accent`. One-shot, sin modal.
